      ...
      <React.Fragment>
        ...
        <div className="header">
          ...
          <div className="z-10 text-center wrapper">
            <h2 className="font-gabriela text-white lg:text-4xl">The life of</h2>
            <h1 className="font-gabriela text-white lg:text-6xl pb-6">Arthur Conan-Doyle</h1>
            <p className="text-white lg:text-2xl">The best way to navigate the life of Arthur Conan-Doyle, lets get started</p>
