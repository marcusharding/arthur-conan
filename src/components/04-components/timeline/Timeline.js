...
const slideData = [
    ...
    },
    {
      index: 5,
      date: '1887',
      headline: 'Study in scarlet published in beeton\'s christmas annual',
      text: 'Beeton\'s Christmas Annual was a paperback magazine printed in England yearly between 1860 and 1898, founded by Samuel Orchart Beeton. The November 1887 issue contained a novel by Arthur Conan Doyle entitled A Study in Scarlet which introduced the characters Sherlock Holmes and his friend Watson. Experts described this as "the most expensive magazine in the world”',
      src: ACD6
    },
    {
      index: 6,
