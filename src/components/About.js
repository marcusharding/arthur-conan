        ...
        return(
            <Div100vh>
                <div className="lg:h-full flex flex-col justify-center w-90 mx-auto py-12 lg:py-0">
                    <h1 className="text-white text-3xl pb-8"><span className="text-secondary font-semibold">About</span> the Arthur Conan Doyle collection</h1>
                    <p className="text-white lg:text-xl pb-24">
                    ...
                    <div className="flex flex-col lg:flex-row">
                        <div className="lg:w-1/2 text-white flex flex-col justify-between pb-12 lg:pb-0">
                            <div>
                                <h2 className="text-xl pb-4">You can contact and find us at the following address:</h2>
                            </div>
                            <div className="pb-8">
                        ...
                        <div className="lg:w-1/2 text-white flex flex-col justify-between">
                            <div>
                                <h2 className="text-xl pb-4">Or discover the Museum collection at following address:</h2>
                            </div>
                            <div className="pb-8">
