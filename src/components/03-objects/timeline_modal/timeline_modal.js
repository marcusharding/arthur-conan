...
export class TimelineModal extends React.Component {
    ...
    render() {
        return(
            <React.Fragment>
                <div className={`absolute w-1/3 h-full z-50 left-0 text-white items-center flex-col justify-center text-center hidden lg:${this.props.slides.arthursHouse === true && this.props.modalActive === true ? 'flex' : 'hidden'} ${this.props.slides.index === this.props.current ? 'visible' : 'invisible'}`}>
